...
class Track:
    ...
    def __init__(self, mean, covariance, track_id, class_id, n_init, max_age,
                features=[], age=1, time_since_update=0, hits=1, state = TrackState.Tentative, yolo_bbox=[0,0,0,0]):
        self.mean = mean
        self.covariance = covariance
        self.track_id = track_id
        self.class_id = class_id
    ...
    def predict(self, kf):
        ...
        # return self.mean, self.covariance, self.age, self.time_since_update
