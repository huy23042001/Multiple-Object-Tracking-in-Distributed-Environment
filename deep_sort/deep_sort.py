...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, classes, ori_img, tracks, samples, use_yolo_preds=True):
        self.tracker.tracks = tracks
        self.tracker.metric.samples = samples
        max = 0
        ...
        return outputs, self.tracker.tracks, self.tracker.metric.samples
